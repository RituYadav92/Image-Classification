...
def dataset(dataset_name):
    ...
    if (dataset_name == 'cifar10'):
        ...
        sys.stdout.write("| ")
        trainset = torchvision.datasets.ImageFolder(root='./Breed/dataset1/train', transform=transform_training())
        testset = torchvision.datasets.ImageFolder(root='./Breed/dataset1/validate', transform=transform_testing())
        outputs = 120
        inputs = 3
